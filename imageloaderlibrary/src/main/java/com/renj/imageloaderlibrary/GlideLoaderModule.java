...
public class GlideLoaderModule implements IImageLoaderModule {
    ...
    @Override
    public void loadImage(@NonNull Fragment fragment, @NonNull String url, @NonNull ImageView imageView) {
        ImageInfoConfig imageInfoConfig = new ImageInfoConfig.Builder()
                .fragment(fragment)
                .url(url)
                .target(imageView)
    ...
    @Override
    public void loadImage(@NonNull android.support.v4.app.Fragment fragment, @NonNull String url, @NonNull ImageView imageView) {
        ImageInfoConfig imageInfoConfig = new ImageInfoConfig.Builder()
                .fragmentV4(fragment)
                .url(url)
                .target(imageView)
